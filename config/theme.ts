export const theme = {
  ...
  calendar: {
    ...
    // URL resuelta (sin redirect) — es la que se embebe en iframe
    embedUrl:
      "https://calendar.google.com/calendar/appointments/schedules/AcZssZ3uh29oUAWKcGKAdlyPArpitQxjUamJCiOJVIn8cN3YC4oW0NlyTLQczEn1Byb5zQr7KVCgMuIU",
