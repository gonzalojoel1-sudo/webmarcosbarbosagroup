    ...
    <footer className="bg-ink text-white">
      <div className="max-w-7xl mx-auto px-6 py-12 md:py-16">
        <div className="grid md:grid-cols-4 gap-10">
          <div>
            <p className="font-display text-xl leading-none">MARCOS BARBOSA</p>
          ...
          <div>
            ...
            <Link
              href="/contacto"
              className="mt-6 inline-flex bg-primary hover:bg-[#e03a00] text-white px-5 py-2 rounded-full text-sm font-medium transition-colors"
            >
              Agendar Reunión
            </Link>
          </div>
